...
public interface IssuedCredentialService {
    ...
    void reIssueCredential(EmployeeDTO employeeDTO) throws EmployeeAlreadyExistsException, CredentialForEmployeeAlreadyExistsException, EmployeeNotFoundException, ConnectionNotFoundException, IssuedCredentialNotFoundException;
